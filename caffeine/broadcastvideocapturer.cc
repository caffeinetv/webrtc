...
cricket::CaptureState BroadcastVideoCapturer::Start(
    cricket::VideoFormat const& format) {
...
void BroadcastVideoCapturer::SendVideo(uint8_t const* frameData,
...
void BroadcastVideoCapturer::Stop() {}

bool BroadcastVideoCapturer::IsRunning() {
  return true;
}

bool BroadcastVideoCapturer::IsScreencast() const {
  return false;
}

bool BroadcastVideoCapturer::GetPreferredFourccs(
